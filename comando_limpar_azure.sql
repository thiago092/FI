-- COMANDO COMPLETO PARA LIMPAR FINANCIAMENTOS NO AZURE SQL DATABASE
...
UNION ALL
SELECT 'transacoes_financiamento' as tabela, COUNT(*) as registros FROM transacoes WHERE is_financiamento = 1;
...
UPDATE transacoes 
SET is_financiamento = 0, 
    parcela_financiamento_id = NULL 
WHERE is_financiamento = 1 OR parcela_financiamento_id IS NOT NULL;
